...
<template>
  <svg class="icon icon--cta icon--block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 68.02 67.95">
    ...
    <g v-if="name == 'smiley'" class="smiley">
      <circle class="smiley__head" cx="33.56" cy="35.06" r="30" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="5"/>
      <ellipse class="smiley__eye-left" cx="25.57" cy="20.18" rx="4.63" ry="5.14"/>
      <ellipse class="smiley__eye-right" cx="41.56" cy="20.18" rx="4.63" ry="5.14"/>
    ...
    <g v-if="name == 'heart'" class="heart">
      ...
      <path class="heart__bump" d="M58 33.16a10.29 10.29 0 00.45-3 10.07 10.07 0 10-19.67 3z" transform="translate(-1.81 -0.15)"/>
    </g>
    <g v-if="name == 'flashed'" class="flashed">
      <circle class="flashed__outline" cx="33.22" cy="34.59" r="30" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="5"/>
      <path class="flashed__eye-left__outline" fill="var(--c-design-background, #fff)" d="M33.81 35.9L22.57 30l-11.25 5.9 2.15-12.53-9.1-8.87 12.57-1.82 5.63-11.4 5.62 11.4 12.57 1.82-9.1 8.87zM21.56 20.09l.5.49-.12.69.63-.33.62.33-.12-.69.5-.49-.69-.1-.32-.63-.31.63z" transform="translate(-1.81 -0.15)"/>
      <path class="flashed__eye-right__outline" fill="var(--c-design-background, #fff)" d="M56.75 36.66L44.84 30.4l-11.91 6.26 2.28-13.27L25.57 14l13.32-1.93L44.84 0l5.96 12.07L64.11 14l-9.63 9.39 2.27 13.27z"/>
      <path class="flashed__mouth" d="M21.8 31.65a13.94 13.94 0 1027.25 4.17 13.72 13.72 0 00-.64-4.17z" transform="translate(-1.81 -0.15)"/>
    ...
    <g v-if="name == 'raumgleiter'" class="raumgleiter">
      <path class="raumgleiter_r" d="M24.33 19.38v33.17h10.82V19.38zm27.2 8.75c.07-.72.13-1.52.13-2.25a7.09 7.09 0 00-7.43-7.23 7.09 7.09 0 00-7.29 7.23c0 .8.06 1.53.13 2.25z" transform="translate(-1.81 -0.15)"/>
      <circle class="raumgleiter__outline" cx="33.52" cy="35.45" r="30" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="5"/>
    </g>
    <g v-if="name == 'thumb'" class="thumb" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="5">
      <path class="thumb__thumb" d="M22.15 31.66c7.08 0 15.38-5.74 15.38-12.82v-4.67a6.31 6.31 0 0112.61 0v17.49H62.5a4.81 4.81 0 014.63 6.13l-5.51 22.35a4.39 4.39 0 01-4.22 3.19H30.76a8.4 8.4 0 01-8.39-8.4z" transform="translate(-1.81 -0.15)"/>
    ...
    <g v-if="name == 'communication'" class="communication">
      ...
      <g class="communication__boubble--right">
        ...
        <path class="communication__line" fill="none" stroke="var(--c-design-background, #fff)" stroke-miterlimit="10" stroke-width="3" d="M29.72 47.71h21.02"/>
        <path class="communication__line" fill="none" stroke="var(--c-design-background, #fff)" stroke-miterlimit="10" stroke-width="3" d="M29.72 41.64h26.71" data-name="communication__line"/>
        <path class="communication__line" fill="none" stroke="var(--c-design-background, #fff)" stroke-miterlimit="10" stroke-width="3" d="M29.72 35.57h12.54" data-name="communication__line"/>
      </g>
    </g>
  </svg>
</template>
